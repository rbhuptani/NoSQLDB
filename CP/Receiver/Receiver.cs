...
namespace Project4Starter
{
  ...
  public class Receiver
  {
    ...
    public bool last_executed  = false;
    ...
    public void setlastMID(string mid)
    {
        last_mid = mid;
    }
    public bool getBool() {
    ...
    public Action defaultServiceAction()
    {
      ...
      {
        if(true)
          Console.Write("\n  starting Receiver.defaultServiceAction :: " + this.ToString());
        Message msg = null;
        while (true)
        {
          msg = getMessage();   // note use of non-service method to deQ messages
          if(msg.content.Contains(last_mid)){
                  last_executed = true;
                  last_mid = "";
          }
