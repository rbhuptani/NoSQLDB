 ...
 * --------------------
 * ver 1.3 : 01 Oct 15
 * - added show function for <string,List<string>> database
 * ver 1.2 : 24 Sep 15
...
namespace Project2Starter
{
  ...
  public static class DisplayExtensions
  {
    ...
    public static void showElement(this DBElement<string, List<string>> enumElement)
    {
    ...
    public static void showDB(this DBEngine<string, DBElement<string, List<string>>> db)
    {
    ...
    public static void showDBF(this DBFactory<string, DBElement<string, List<string>>> dbf)
    {
        dbf.show<string, DBElement<string, List<string>>, List<string>, string>();
    }
    public static void showDBF(this DBFactory<int, DBElement<int, string>> dbf)
    {
            dbf.show<int, DBElement<int, string>, string>();
    }
    public static string dbf_to_string(this DBFactory<string, DBElement<string, List<string>>> dbf)
    {
        return dbf.dbf_to_string<string, DBElement<string, List<string>>, List<string>, string>();
    }
  }
