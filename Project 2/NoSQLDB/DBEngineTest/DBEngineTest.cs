...
*   - Requirement 2 and 3(first part): adding <int,string> type of elements & <string, List<string>> type of elements into DBEngine dbstore
*   - Requirement 3 (second part):     deleting <int,string> type of elements & <string, List<string>> type of elements
*   - Requirement 4:                   editing <int,string> type of elements & <string, List<string>> type of elements
*/
 ...
 * --------------------
 * ver 1.1 : 29 Sep 2015
 * - added test functionality of editing and deleting values from DBStore
 * ver 1.0 : 24 Sep 15
 * - first release
 *
 */
...
namespace Project2Starter
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      WriteLine();
      "testing deletes on <int, string> types of elements ".title();
      db.delete(1);
      db.show<int, DBElement<int, string>, string>();
      Write("\n\n");
      ...
      WriteLine();
      newdb.editMetadata<List<string>>("10", "editied metadata in list<string");
      newdb.editChildren<List<string>>("10", new List<string> { "ch1", "ch2", "ch3" });
      newdb.editPayload("10", new List<string> { "p1", "p2", "p3" });
      newdb.show<string, DBElement<string, List<string>>, List<string>, string>();
      WriteLine();
      "testing deletes for <string, List<string>> type of elements".title();
      newdb.delete("10");
      newdb.show<string, DBElement<string, List<string>>, List<string>, string>();
      Write("\n\n");
      ...
      "testing edits".title();
      db.show<int, DBElement<int, string>, string>();
      db.editMetadata<string>(2, "EditedMetadata");
      db.editChildren<string>(2, new List<int> { 1, 2, 3 });
      db.editPayload(2,"edited payload");
      db.show<int, DBElement<int, string>, string>();
      Write("\n\n");
